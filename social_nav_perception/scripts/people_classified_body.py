...
class PeopleInOdomFrame:
    def __init__(self):
        ...
        self.moving_person_publisher = rospy.Publisher('/social_nav/moving_people/body', Person, queue_size=10)
        self.static_people_publisher = rospy.Publisher('/social_nav/static_people/body', PersonArray, queue_size=10)

        # --- Publishers for RViz Markers ---
        self.moving_person_marker_publisher = rospy.Publisher('/moving_people/markers_body', Marker, queue_size=10)
        self.static_people_markers_publisher = rospy.Publisher('/static_people/markers_body', MarkerArray, queue_size=10)
    ...
    def people_callback(self, msg):
        ...
        try:
            transform = self.tf_buffer.lookup_transform('body', 'zed2i_base_link', rospy.Time(0), rospy.Duration(1.0))
